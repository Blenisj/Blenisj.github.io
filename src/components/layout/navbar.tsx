...
export const NavBar = () => {
  ...
  return (
    <header className="position-fixed top-0 start-50 translate-middle-x w-100 px-3 mt-2 z-3">
      <nav
        className="navbar position-relative navbar-expand-lg border border-secondary rounded-pill shadow mx-auto w-100 px-4 py-2 overflow-hidden"
        style={{ maxWidth: 800, backgroundColor: 'color-mix(in srgb, var(--portfolio-background) 75%, transparent)' }}
      >
        <div className="container-fluid d-flex align-items-center justify-content-between gap-4 p-0">
          <a className="navbar-brand small fw-bold" style={{ color: 'var(--portfolio-muted)' }} href="#top" onClick={closeMenu}>
            <span>Blenis</span>
          </a>
