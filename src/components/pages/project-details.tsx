    ...
    <section className="container min-vh-100 d-flex align-items-center py-5" aria-labelledby="project-title">
      <div className="row justify-content-center w-100">
        <div className="col-lg-9">
          <a className="portfolio-link d-inline-flex align-items-center gap-2 mb-5" href="/#projects">
            <ArrowLeft size={17} aria-hidden="true" />
            Back to projects
          </a>
          <p className="portfolio-kicker mb-3">Project case study</p>
          <h1 id="project-title" className="display-1 fw-semibold mb-4">{project.title}</h1>
